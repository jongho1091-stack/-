...
class TicketView(discord.ui.View):
    ...
    async def create_ticket(self, interaction, category):
        ...
        if discord.utils.get(guild.channels, name=chan_name): return await interaction.response.send_message(f"이미 티켓이 열려 있습니다!", ephemeral=True)
